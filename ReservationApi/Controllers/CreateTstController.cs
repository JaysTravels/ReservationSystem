...
namespace ReservationApi.Controllers
{
    ...
    [ApiController]
    public class CreateTstController : ControllerBase
    {
        ...
        //[Authorize]
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] TicketTstRequest req)
        {

            ApiResponse res = new ApiResponse();

            var data = await _Repo.CreateTicketTst(req);
