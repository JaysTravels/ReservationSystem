...
using ReservationSystem.Infrastructure.Repositories.HotelRepositories;
...
builder.Services.AddScoped<IHotelAvailailityRepository, HotelAvailabilityRepository>();
...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowOrigin",
        builder => builder
			...
			.WithOrigins("https://www.jaystravels.co.uk/").WithOrigins("https://www.jaystravels.co.uk") 
			.AllowAnyMethod()
            .AllowAnyHeader()
            .AllowCredentials());
});
